...
def test_list_todos_filter_title_should_return_5_results(
    session, client, user, token
):
    expected_todos = 5
...
def test_list_todos_filter_state_should_return_5_results(
    session, client, user, token
):
    expected_todos = 5
    session.bulk_save_objects(
...
def test_todo_patch_error(client, token):
...
def test_todo_patch(session, client, user, token):
